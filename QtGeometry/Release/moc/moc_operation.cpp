...
void OperationDelete::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OperationDelete *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (OperationDelete::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OperationDelete::sigDeleteFeatures)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject OperationDelete::staticMetaObject = { {
    QMetaObject::SuperData::link<Operation::staticMetaObject>(),
    qt_meta_stringdata_OperationDelete.data,
    qt_meta_data_OperationDelete,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OperationRotate *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (OperationRotate::*)(GeoFeature * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OperationRotate::sigSendFeatureToGPU)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject OperationRotate::staticMetaObject = { {
    QMetaObject::SuperData::link<Operation::staticMetaObject>(),
    qt_meta_stringdata_OperationRotate.data,
    qt_meta_data_OperationRotate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
